...
void main() {
  test('buildEditorDraftSnapshot normalizes tags and markdown body', () {
  ...
  test('restored draft snapshot matches live pending attachment fingerprints', () {
