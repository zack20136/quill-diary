...
import 'package:quill_diary/presentation/home/widgets/home_entry_preview_body.dart';

import '../../helpers/shared/widget_test_app.dart';

Widget _previewApp(Widget child) {
...
void main() {
  testWidgets('依 markdown 順序顯示內容', (WidgetTester tester) async {
  ...
  testWidgets('文字剩一行時只顯示第一個任務項目', (WidgetTester tester) async {
    await tester.pumpWidget(
      _previewApp(
        const HomeEntryPreviewBody(
          previewMarkdown: '短前言\n- [ ] 564\n- [ ] 545645645',
  ...
  testWidgets('文字已佔滿最大行數時隱藏任務項目', (WidgetTester tester) async {
  ...
  testWidgets('達到行數預算後不會跳過後續行', (WidgetTester tester) async {
    await tester.pumpWidget(
      _previewApp(
        const HomeEntryPreviewBody(
          previewMarkdown:
  ...
  testWidgets('文字足夠時仍顯示任務項目', (WidgetTester tester) async {
    await tester.pumpWidget(
      _previewApp(
        const HomeEntryPreviewBody(
          previewMarkdown: '短前言\n- [x] 已完成\n- [ ] 任務三',
