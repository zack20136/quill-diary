...
class SessionNavigationRequest {
  const SessionNavigationRequest._({required this.action, this.location});
...
final sessionNavigationRequestProvider =
    NotifierProvider<
      SessionNavigationRequestController,
      SessionNavigationRequest?
    >(SessionNavigationRequestController.new);

final sessionNavigationCoordinatorProvider =
    Provider<SessionNavigationCoordinator>(
...
class SessionNavigationCoordinator {
  ...
  void publishUnlockNavigation(
    SessionUnlockResultEvent event,
    AppSessionState nextState,
  ) {
