...
| [Google-Play-Billing.md](./Google-Play-Billing.md) | 支持頁與 Billing 規劃、商品方向與未來實作清單 |
...
4. 若未來要做支持功能，再看 [Google-Play-Billing.md](./Google-Play-Billing.md)

## 目前定位

- Google Drive 備份屬於現有功能的一部分
- Google Play 上架屬於發佈整備
- Billing 目前仍是規劃文件，不是已完成實作
