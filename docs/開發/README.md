...
- 想理解日記庫檢查、修復前備份與手動修復：看 [功能/日記庫檢查與修復.md](./功能/日記庫檢查與修復.md)
- 想理解人物名冊、姓名命中與延遲分析：看 [功能/人物與姓名查詢.md](./功能/人物與姓名查詢.md)
...
| [功能/日記庫檢查與修復.md](./功能/日記庫檢查與修復.md) | 檢查、修復前備份、附件救援、手動修復與隔離流程 |
| [功能/人物與姓名查詢.md](./功能/人物與姓名查詢.md) | 加密人物名冊、姓名／別名查詢、延遲分析與備份邊界 |
