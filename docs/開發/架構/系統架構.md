...
| People | 加密人物名冊、姓名/別名查詢、人物詳情與提及統計 |
...
| `people/` | 人物名冊、人物分頁、詳情與提及統計 provider |
...
- 讀寫 entry / asset / manifest，並協調人物名冊與人物分析
- 驗證與修復 vault 內正式資料
...
| `vault/people.json.enc` | 加密人物名冊；完整備份包含，人物分析 SQLite 不包含 |
